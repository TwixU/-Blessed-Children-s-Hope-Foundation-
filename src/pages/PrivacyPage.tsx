...
const ContentBlock: React.FC = () => (
  <div className="prose prose-lg max-w-4xl mx-auto py-16 px-4 sm:px-6 lg:px-8 text-gray-700 leading-relaxed">
    ...
    <p>
      Blessed Children's Hope Foundation ("we," "our," or "us") is committed to protecting your privacy. This Privacy Policy explains how we collect, use, disclose, and safeguard your information when you visit our website coalitionforcyf-charity.org. Please read this privacy policy carefully. If you do not agree with the terms of this privacy policy, please do not access the site.
    </p>
    ...
    <p>
      We will not share, sell, rent or trade your personal information with any third parties for their commercial purposes. We may share information we have collected about you in certain situations. Your information may be disclosed as follows:
    </p>
    <ul>
      <li>
    ...
    <h2>6. Contact Us</h2>
    <p>
      If you have questions or comments about this Privacy Policy, please contact us at: info@coalitionforcyf-charity.org.
    </p>
  </div>
);
